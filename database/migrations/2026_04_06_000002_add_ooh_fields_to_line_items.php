...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('plan_line_items', function (Blueprint $table) {
            ...
            // Airing
            $table->time('time_from')->nullable()->after('end_date');
        ...
        Schema::table('booking_line_items', function (Blueprint $table) {
            // Location
            $table->string('city')->nullable()->after('targeting_names');
            $table->unsignedInteger('qty_location')->nullable()->after('city');
            $table->unsignedInteger('qty_screen')->nullable()->after('qty_location');
    ...
    public function down(): void
    {
        ...
        Schema::table('plan_line_items', fn (Blueprint $t) => $t->dropColumn($cols));
        Schema::table('booking_line_items', fn (Blueprint $t) => $t->dropColumn($cols));
    }
};
